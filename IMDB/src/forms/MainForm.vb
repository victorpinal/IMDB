...
#Region "Inicializacion"
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        Try
			...
			AddHandler uxtxtBuscar.TextChanged, Sub() 
			                                    	If (uxtxtBuscar.Text.Length > 2) Then
			                                    		FiltraYPintaGrid() 'Al menos buscar 3 caracteres
			                                    	End If
			                                    	End Sub
...
#Region "Utilidades"
    ...
    Private Function getObj(obj As Object,propName As String) As Object
    	Return obj.GetType().GetProperty(propName).GetValue(obj,Reflection.BindingFlags.GetProperty,Nothing,Nothing,Nothing)
    End Function
        ...
        Try
            ...
            For Each myGridRow As DataGridViewRow In gridRows
                ...
                If (response IsNot Nothing) Then
                    ...
                    Dim Rating As Decimal
                    Dim RatingCount As Integer
                    Decimal.TryParse(getObjValue(getObj(response,"data"),"rating"), Rating)
                    Integer.TryParse(getObjValue(getObj(response,"data"),"num_votes"), Globalization.NumberStyles.AllowThousands, Globalization.CultureInfo.InvariantCulture, RatingCount)
                    baseDatos.ExecuteNonQuery("UPDATE film SET imdb_rating=@imdb_rating, imdb_ratingcount=@imdb_ratingcount WHERE id=@id",
                                                  {New MySqlClient.MySqlParameter("@imdb_rating", Rating),
                                                   New MySqlClient.MySqlParameter("@imdb_ratingcount", RatingCount),
                                                   New MySqlClient.MySqlParameter("@id", myRow("id"))})
